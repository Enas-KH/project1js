...
const display = (obj, arrayname) => {
    ...
    let authorCell = document.createElement('h5');
    ...
    if (arrayname === "Books") {
        ...
        button.setAttribute("class","button fas fa-book-heart")
        ...
        ss.appendChild(temp);
        button.setAttribute("class","button fas fa-trash")
        button.addEventListener("click", e => {
...
console.log(document.getElementById('newBook'));
